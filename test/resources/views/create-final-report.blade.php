        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('process-final-form', ['id' => $folder->id]) }}" method="POST">
                        @csrf
                        ...
                        <h3 class="font-semibold text-md text-gray-800 pt-3">Final:<h3>
                        <div class="p-6 bg-white border-b border-gray-200">
                            <label>Comments:</label>
                            <textarea name="final" class="mb-4 form-input rounded-md shadow-sm mt-1 block w-full"></textarea>
                            <label>Mark:</label>
                            <input type="number" name="final[mark]" class="form-input rounded-md shadow-sm mt-1 block w-full" value=>
                        </div>

                        <h3 class="font-semibold text-md text-gray-800 pt-3">Signatures: </h3>
